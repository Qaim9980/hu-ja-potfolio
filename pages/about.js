...
export default function About() {
  ...
  const getCategoryColors = (category) => {
    switch (category) {
      case 'trigger':
        return {
          bg: 'from-clay/20 to-copper/10',
          border: 'border-clay/40',
          hover: 'hover:border-clay/70 hover:shadow-clay/20',
          text: 'text-clay/90'
        };
      case 'data':
        return {
          bg: 'from-olive/20 to-clay/10',
          border: 'border-olive/40',
          hover: 'hover:border-olive/70 hover:shadow-olive/20',
          text: 'text-olive/90'
        };
      case 'comms':
        return {
          bg: 'from-copper/20 to-olive/10',
          border: 'border-copper/40',
          hover: 'hover:border-copper/70 hover:shadow-copper/20',
          text: 'text-copper/90'
        };
      case 'logic':
        return {
          bg: 'from-clay/20 to-sand/10',
          border: 'border-clay/40',
          hover: 'hover:border-clay/70 hover:shadow-clay/20',
          text: 'text-clay/90'
        };
